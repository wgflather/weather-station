...
class WeatherControllerTest {
    ...
    void shouldReturnLatestWeatherRecord_whenDataExists() throws Exception {
        ...
        WeatherRecord entity = WeatherRecord.builder()
                .measuredAt(instant)
                .temperature(20.0)
                .pressure(1000.0)
                .build();
        ...
        mockMvc.perform(get(WeatherController.LATEST_WEATHER_PATH)
                ...
                .andExpect(jsonPath("$.measuredAtTimeZoned", is(savedRecord.getMeasuredAtTimeZoned().format(JSON_FORMAT))));
    ...
    void shouldReturnDashboard_WhenDataAvailable() throws Exception {
        ...
        WeatherDashboardDto dashboardDto = WeatherDashboardDto.builder()
                .metricsDashboardDto(com.flather.weatherstation.dto.dashboard.MetricsDashboardDto.builder()
                        .temperature(new TemperatureDto(23.0, 18.0, 32.0))
                        .pressure(new PressureDto(1000.0))
                        .build())
                .systemHealthDashboardDto(SystemHealthDashboardDto.builder()
        ...
        mockMvc.perform(get(WeatherController.BASE_PATH + "/dashboard")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.systemHealthDashboardDto.status",
                        is(DataStatus.LIVE.toString())));
    ...
    void shouldReturnChart_WithTemperatureMetric() throws Exception {
        ...
        HourlyChartAvgDto point1 = new HourlyChartAvgDto(ZonedDateTime.parse("2026-05-20T10:00Z"), 21.5);
        HourlyChartAvgDto point2 = new HourlyChartAvgDto(ZonedDateTime.parse("2026-05-20T11:00Z"), 23.0);
        ...
        mockMvc.perform(get(WeatherController.BASE_PATH + "/chart")
    ...
    void shouldReturnChart_WithPressureMetric() throws Exception {
        ...
        HourlyChartAvgDto point1 = new HourlyChartAvgDto(ZonedDateTime.parse("2026-05-20T10:00Z"), 1010.0);

        ChartDto chart = new ChartDto("pressure", List.of(point1), now.plusSeconds(600));

        given(analyticsService.returnChart(eq("pressure"), nullable(String.class)))
                .willReturn(chart);
