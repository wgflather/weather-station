 ...
 * @param phaseDegrees precise phase angle 0–360°: 0=new moon, 90=first quarter, 180=full, 270=last
 *     quarter. Used by the frontend canvas renderer to draw the terminator accurately without
 *     reconstructing it from illuminationPercent + phaseName.
 */
